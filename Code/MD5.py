class MD5(object):
    ...
    def operationFunction(self, a, b, c, d, fun, m, s, K):
        func_sum = (a + fun(b, c, d) + int(m) + K) % self.max_int
            ...
            for ii in range(64):
                if ii < 16:
                    self.A, self.B, self.C, self.D = self.D, \
                                                     self.operationFunction(self.A, self.B, self.C, self.D, self.F,
                                                                            M[ii], self.S[ii], self.K[ii]), \
                                                     self.B, \
                                                     self.C
                elif ii < 32:
                    self.A, self.B, self.C, self.D = self.D, \
                                                     self.operationFunction(self.A, self.B, self.C, self.D, self.G,
                                                                            M[(ii * 5 + 1) % 16], self.S[ii],
                                                                            self.K[ii]), \
                                                     self.B, \
                                                     self.C
                elif ii < 48:
                    self.A, self.B, self.C, self.D = self.D, \
                                                     self.operationFunction(self.A, self.B, self.C, self.D, self.H,
                                                                            M[((ii * 3) + 5) % 16], self.S[ii],
                                                                            self.K[ii]), \
                                                     self.B, \
                                                     self.C
                else:
                    self.A, self.B, self.C, self.D = self.D, self.operationFunction(self.A, self.B, self.C, self.D,
                                                                                    self.I,
                                                                                    M[ii * 7 % 16], self.S[ii],
                                                                                    self.K[ii]), \
                                                     self.B, \
